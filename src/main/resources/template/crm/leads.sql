#namespace("crm.leads")
  #sql("queryById")
    ...
    from aptenon_crm_leads as a left join aptenon_admin_user as b on a.owner_user_id = b.user_id
    where leads_id = ?
  #end

  #sql("deleteByIds")
    delete from aptenon_crm_leads where leads_id = ?
  #end

  #sql ("updateOwnerUserId")
    update aptenon_crm_leads
  ...
  #sql ("queryBatchIdByIds")
    select batch_id from aptenon_crm_leads where leads_id in (#fori(ids))
  #end
#end
