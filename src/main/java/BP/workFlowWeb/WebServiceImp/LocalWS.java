package BP.workFlowWeb.WebServiceImp;
...
import BP.workFlowWeb.WebService.LocalWSI;
...
public class LocalWS implements LocalWSI {
	...
	public String Flow_DoFlowOverQiangZhi(String flowNo, long workID, String msg, String userNo) throws Exception {
		Dev2Interface.Port_Login(userNo);
		return Dev2Interface.Flow_DoFlowOver(flowNo, workID, msg,1);
...
//		return BP.Tools.Json.ToJson(ds);
	...
	public String DeleteFlow(String userNo,long workid,String fk_flow) throws Exception{
		Dev2Interface.Port_Login(userNo);
		return Dev2Interface.Flow_DoDeleteFlowByReal(fk_flow, workid, true);
	}
