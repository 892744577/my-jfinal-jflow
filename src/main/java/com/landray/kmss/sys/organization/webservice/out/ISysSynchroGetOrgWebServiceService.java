 ...
 * 2020-11-26T09:29:32.946+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "ISysSynchroGetOrgWebServiceService", 
                  wsdlLocation = "http://tenonoa.aptenon.com:9300/sys/webservice/sysSynchroGetOrgWebService?wsdl",
...
public class ISysSynchroGetOrgWebServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://tenonoa.aptenon.com:9300/sys/webservice/sysSynchroGetOrgWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ISysSynchroGetOrgWebServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://tenonoa.aptenon.com:9300/sys/webservice/sysSynchroGetOrgWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
