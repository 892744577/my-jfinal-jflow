...
public class WebServiceConfig {
	...
	private void loadCfg() {
		...
		try {
			...
			prop.setProperty("address","http://tenonoa.aptenon.com:9300/sys/webservice/kmReviewWebserviceService");
			prop.setProperty("service_class","com.landray.kmss.km.review.webservice.IKmReviewWebserviceService");
			prop.setProperty("service_bean","kmReviewWebserviceService");
