        ...
        if(! userId.equals(BaseConstant.SUPER_ADMIN_USER_ID)){
            if(tablePara != null){
                if("addOrUpdate".equals(split[2]) || "saveAndUpdate".equals(split[2])){
                    ...
                    if("aptenon_crm_customer".equals(tablePara.get("tableName"))){
                    ...
                    }else if("aptenon_crm_leads".equals(tablePara.get("tableName"))){
                    ...
                    }else if("aptenon_crm_contract".equals(tablePara.get("tableName"))){
                    ...
                    }else if("aptenon_crm_contacts".equals(tablePara.get("tableName"))){
                    ...
                    }else if("aptenon_crm_business".equals(tablePara.get("tableName"))){
                    ...
                    }else if("aptenon_crm_receivables".equals(tablePara.get("tableName"))){
