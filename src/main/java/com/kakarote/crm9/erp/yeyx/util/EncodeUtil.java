...
public class EncodeUtil {
     ...
     * @throws Exception
     */
    public static String encryption(String secretKey,String plainData) throws Exception{
     ...
     * @throws Exception
     */
    public static String decryption(String secretKey,String secretData) throws Exception{
