...
public class PictureUtil {
         ...
         * @return void
         */
        public static final BufferedImage combineCodeAndPicToFile(String backPicPath, BufferedImage code/*String fillPicPath*/) {
            try {
	        ...
	        BufferedImage small = ImageIO.read(new File(fillPicPath));*/
                ...
                return big;
                //ImageIO.write(big, backPicPath.substring(backPicPath.lastIndexOf(".") + 1), new File("C:\\Users\\tenon\\Desktop\\combinePic.jpg"));
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        public static BufferedImage createImage(String content, String logoImgPath, boolean needCompress) throws IOException, WriterException {
            ...
            //ImageIO.write(image, "jpg", new File("C:/Users/tenon/Desktop/zxing1.jpg"));//输出带logo图片
            // 没有logo
        ...
        /*public static final void main(String[] args) throws IOException, WriterException {
            ...
            combineCodeAndPicToFile("C:/Users/tenon/Desktop/9.png", code);
